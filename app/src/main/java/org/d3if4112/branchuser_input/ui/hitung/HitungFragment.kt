...
import org.d3if2014.hitungbmi.db.BmiDb
import org.d3if4112.branchuser_input.R

import org.d3if4112.branchuser_input.databinding.FragmentHitungBinding
...
class HitungFragment : Fragment() {
    ...
    private val viewModel: HitungViewModel by lazy {
        val db = BmiDb.getInstace(requireContext())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.hitung.setOnClickListener { hitungBmi() }
